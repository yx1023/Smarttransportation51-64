...
public class ZT_1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.zt_1,null);
    }
        ...
        new H().sendResuilt("get_bus_stop_distance", jsonObject.toString(), "POST", new Callback() {
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                ...
                try {
                    ...
                    list=new Gson().fromJson(jsonObject1.optJSONArray("中医院站").toString(),new TypeToken<List<Bus>>(){}.getType());
