...
public class Gv_Adapter2 extends ArrayAdapter<String> {

    public Gv_Adapter2(@NonNull Context context, List<String> resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        HV hv;
        if(convertView==null){
            convertView= LayoutInflater.from(getContext()).inflate(R.layout.gv_item2,parent,false);
            hv=new HV();
